              ...
              <div className="row align-items-center g-5 py-5">
                ...
                <div className="col-12 col-sm-6 col-md-6 col-lg-6 mt-0">
                  ...
                  <div className="d-flex align-items-center">
                    <h4 className="fw-bold m-0" style={{ color: "#894B8D" }}>{productDetails.discount}$</h4>
                    <s className="fw-bold mx-2" style={{ color: "#B9BDC8", fontSize: "23px" }}>{productDetails.price}$</s>
                  </div>
                  <hr />
                  ...
                  <div className="d-flex align-items-center">
                    ...
                    <button onClick={() => {
                      ...
                      <GoHeart style={{width:"30px", height:"30px"}}/></button>
                  </div>
                </div>
              </div>
            </div>
