              ...
              <div className="col-12 col-sm-8 col-md-8 col-lg-8">
                ...
                <table className="table table-version-first">
                  ...
                  <tbody>
                    ...
                    {items.map(item => (
                      <tr>
                        <th scope="row"><Link to={"/shop"}><img src={`https://petpal-backend-en2xs.kinsta.app/${item.coverImg?.replace(/\\/g, "/")}`} style={{ width: "250px", height: "200px" }} /></Link></th>
                        <td>{item.name}</td>
                        <td>{item.price}$</td>
                    ...
                    {items.map(item => (
                      <div className="col-12 col-sm-6 col-md-6 col-lg-6">
                        <div className="d-flex justify-content-center align-items-center flex-column">
                          <img src={`https://petpal-backend-en2xs.kinsta.app/${item.coverImg?.replace(/\\/g, "/")}`} style={{ width: "100%", height: "280px" }} alt="..." />
                        </div>
